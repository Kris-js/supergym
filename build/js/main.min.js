...
},{"./tabs":16}],4:[function(require,module,exports){
"use strict";
...
require("./modules/trainer-swiper");
require("./modules/review-swiper");
...
},{"./init-accordion":2,"./init-tabs":3,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./modules/review-swiper":14,"./modules/trainer-swiper":15,"./utils/ios-vh-fix":19}],5:[function(require,module,exports){
"use strict";
...
var swipers = new Swiper('.review__swiper', {
...
exports.swiperTrainer = void 0;
var Swiper = window.Swiper;
var swiperTrainer = new Swiper('.trainer__swiper', {
  direction: 'horizontal',
  pagination: {
    el: '.swiper-pagination',
    clickable: true
...
exports.swiperTrainer = swiperTrainer;
